...
{   
    public static class _stats{
        public static readonly Dictionary<StatType, StatModifier> statModifiers = new Dictionary<StatType, StatModifier>() {
        ...
        public static readonly Dictionary<StatType, Stat> stats = new Dictionary<StatType, Stat>() {
